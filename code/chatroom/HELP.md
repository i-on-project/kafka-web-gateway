Start application and open browser on http://localhost:8080/, enter "ws://localhost:8080/name" and click connect.
Send a message and all connected users will receive it.
